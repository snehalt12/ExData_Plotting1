...
if (!file.exists(fileName))
  ...
  plot(datetime, as.numeric(selectedDateData$Global_active_power), type="l",
     xlab="",ylab = "Global Active Power(kilowatts)")

  plot(datetime, as.numeric(selectedDateData$Voltage), type="l",
       xlab="",ylab = "Voltage")
  ...
  plot(datetime, as.numeric(selectedDateData$Global_reactive_power), type="l",
